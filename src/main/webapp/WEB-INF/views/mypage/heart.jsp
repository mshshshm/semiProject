            ...
            <div class="my_recipe recipe_list">
                    ...
                    <ul>
                        ...
                        <c:if test="${recipeList.size() == 0}">
                            <li class="my_recipe_item recipe_item">
                                <div class="name_box">
                                    <p class="recipe_name">찜한 레시피가 없습니다</p>
                                </div>
                            </li>
                        </c:if>
                ...
                <div class="page">
                    <ul class="pagination">
                        ...
                        <c:if test="${pVO.nowPage>1}">
                            <li class="page-item"><a class="page-link" href="/mypage/heart?nowPage=${pVO.nowPage-1}">prev</a></li>
                        </c:if>
                        <c:forEach var="p" begin="${pVO.startPage }" end="${pVO.startPage+pVO.onePageCount-1}">
                            <c:if test="${p<=pVO.totalPage }">
                                <c:if test="${p==pVO.nowPage }">
                                    <li class="page-item">
                                    <a class="page-link page-active" href="/mypage/heart?nowPage=${p}">${p}</a>
                                </c:if>
                                <c:if test="${p!=pVO.nowPage }">
                                    <li class="page-item">
                                    <a class="page-link" href="/mypage/heart?nowPage=${p}">${p}</a>
                                </c:if>
                                </li>
                            </c:if>
                        </c:forEach>
                        ...
                        <c:if test="${pVO.nowPage<pVO.totalPage }">
                            <li class="page-item"><a class="page-link" href="/mypage/heart?nowPage=${pVO.nowPage+1}">next</a></li>
                        </c:if>
                        <c:if test="${pVO.nowPage>=pVO.totalPage }">
