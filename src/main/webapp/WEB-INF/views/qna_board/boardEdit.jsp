    ...
    <main>
        <div class="board_wrap">
            ...
            <div class="board_list_wrap">
                ...
                <form method="post" action="${pageContext.servletContext.contextPath}/qna_board/editOk" id="frm" onsubmit="return validateForm()">
                        ...
                        <div class="board_write">
                            <div class="title">
                                <dl>
                                    ...
                                    <dd><input type="text" id="subject" name="subject" placeholder="제목 입력" value=${vo.subject }></dd>
                                </dl>
                            </div>
